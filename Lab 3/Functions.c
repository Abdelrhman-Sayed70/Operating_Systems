...
access page directory entry :
	...
	index :
		type : uint32
		name : PDX(VA)
	page directory entry = ptr_page_directory[PDX(VA)]
...
access page table entry :
	...
	index :
		type : uint32
		name : PTX(VA)
	page table entry = ptr_page_table [PTX(VA)]

===================================================================================
Frames :
	type : int 
	frameNum of page table = directory_entry >> 12 
	frameNum of page = table_entry >> 12 
